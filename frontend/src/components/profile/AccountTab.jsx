...
export default function AccountTab() {
  ...
  // Load the real profile from the API (cookie auth — no token handling needed)
  useEffect(() => {
    getProfile()
      .then((data) => {
        setProfile(data);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      setProfile(updated);
      setUser?.((u) => (u ? { ...u, full_name: updated.full_name, phone: updated.phone } : u));
    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleUpdate} className="flex flex-col gap-6">
        ...
        <div className="border-t border-brand-brown/5 my-2 pt-8">
          <h4 className="text-sm font-bold text-brand-black mb-5">Change Password <span className="text-brand-brown/40 font-normal">(Optional)</span></h4>
