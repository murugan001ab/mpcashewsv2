...
interface OrderItem {
  product_id?: number;
  product?: { id: number; name: string; images?: OrderProductImage[] };
  product_name?: string;
  quantity: number;
  unit_price: string;
}
...
export default function OrdersTab() {
  ...
  const [reviewedProducts, setReviewedProducts] = useState(new Set<number>());
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-col gap-5">
                  <h4 className="text-xs font-bold text-brand-brown/40 uppercase tracking-widest">
                    Items in this order
                  </h4>
                  ...
                  <div className="divide-y divide-brand-brown/5 border-t border-brand-brown/5">
                    {(order.items || []).map((item, idx) => {
                      ...
                      const productImage = primaryImage
                        ...
                        : null;
                      const alreadyReviewed = reviewedProducts.has(productId!);
                            ...
                            {order.status?.toLowerCase() !== "delivered" ? (
                              ...
                              <div className="min-w-[120px]">
                                <ReviewForm
                                  ...
                                  onSubmitted={(id) =>
                                    setReviewedProducts((prev) => new Set(prev).add(id))
                                  }
                                />
                              </div>
                            )}
